...
typedef enum {
    ...
    FIELD_POSITION_SMALL_BOAT,   // This position contains part of the small boat. //1
    FIELD_POSITION_MEDIUM_BOAT,  // This position contains part of the medium boat. //2
    FIELD_POSITION_LARGE_BOAT,   // This position contains part of the large boat. //3
    FIELD_POSITION_HUGE_BOAT,    // This position contains part of the huge boat. //4
    FIELD_POSITION_MISS,    // This position was attacked by the enemy, but was empty. //5

    /// These denote field positions useful for representing the enemy's board
    FIELD_POSITION_UNKNOWN, // It is unknown what is here. Useful for denoting a position on the //6
                            // enemy's board that hasn't been checked.
    FIELD_POSITION_HIT,     // A field position that was attacked and contained part of a boat. //7
    FIELD_POSITION_CURSOR   // This is used merely for use in FieldOled.c for indicating the current //8
 ...
 */
typedef struct {
    FieldPosition field[FIELD_ROWS][FIELD_COLS];//[0-5][0-9]
