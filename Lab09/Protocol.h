 ...
 */
typedef enum {
    HIT_MISS, // Indicates that this coordinate was a guess that missed. //0
    HIT_HIT, // Indicates that a boat was hit at this coordinate. //1
    HIT_SUNK_SMALL_BOAT, // Indicates that the SMALL_BOAT was sunk as a result of this hit. //2
    HIT_SUNK_MEDIUM_BOAT, // Indicates that the MEDIUM_BOAT was sunk as a result of this hit. //3
    HIT_SUNK_LARGE_BOAT, // Indicates that the LARGE_BOAT was sunk as a result of this hit. //4
    HIT_SUNK_HUGE_BOAT, // Indicates that the HUGE_BOAT was sunk as a result of this hit. //5
} HitStatus;
